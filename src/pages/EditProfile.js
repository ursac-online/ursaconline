...
export default function EditProfile() {
  ...
  const showStudent = () => {
    ...
    axios
      .post(
        "https://ursacapi.000webhostapp.com/api/getStudentID.php",
  ...
  const checkPassword = () => {
    if (userPassword == "") {
      ...
      axios
        .post(
          "https://ursacapi.000webhostapp.com/api/individualUpdateStudent.php",
          JSON.stringify(sendData)
        )
        .then((response) => {
  ...
  return (
    <Box mr={2} ml={2}>
      <Box className={classes.root}>
            ...
            <DialogContent>
              {isLoading ? (
                ...
                <Box className={classes.dialogContainer}>
                  ...
                  <DialogContentText>Changes applied</DialogContentText>
                </Box>
              )}
            </DialogContent>
          </Dialog>
        ...
        {/* DIALOG */}
        <Dialog open={passwordDialog} onClose={cancelSubmit}>
          {success ? (
            <Box>
              <DialogContent className={classes.dialogContainer}>
                ...
                <DialogContentText>Changes applied</DialogContentText>
                <DialogContentText>Changes may take time.</DialogContentText>
              </DialogContent>
            </Box>
          ) : (
            <Box>
              <DialogTitle>Enter password to confirm</DialogTitle>
