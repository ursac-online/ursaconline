...
import { AppBar, Avatar, Box, Divider, Drawer, IconButton, List, ListItem, ListItemIcon, ListItemText, makeStyles, Menu, MenuItem, Toolbar, Tooltip, Typography } from '@material-ui/core';
import { AssignmentIndRounded, ChevronLeftRounded, MeetingRoomRounded, MenuRounded, PersonAddRounded, PersonRounded, SupervisorAccountRounded, ViewModule } from '@material-ui/icons';
      ...
      <AppBar className={classes.appBar} position='fixed' color='inherit'>
        <Toolbar>
          ...
          <div className={classes.title}>
            <Link to='/'><img className={classes.iconLogo} src={ursacOnlineLogo} style={{ width: '40px', height: 'auto' }} alt="" /></Link>
          </div>
